...
public interface AmrLibrary extends Library {
	...
	AmrLibrary INSTANCE = (AmrLibrary) Native.loadLibrary(
			"opencore-amrnb", AmrLibrary.class);
	...
	int Encoder_Interface_Encode(Pointer state,  int mode, short[] speech, byte[] out, int forceSpeech);
